        ...
        public class CoopConfigSettings
        {
            ...
            public void GetSettings()
            {
                ...
                SETTING_PlayerStateTickRateInMS = StayInTarkovPlugin.Instance.Config.Bind
                  ("Coop", "PlayerStateTickRateInMS", 50, new ConfigDescription("TCP Only: The rate at which Player States will attempt to be synchronized. Min: 50ms, Max 666ms")).Value;
                SETTING_PlayerStateTickRateInMS = Math.Min(666, Math.Max(50, SETTING_PlayerStateTickRateInMS));
